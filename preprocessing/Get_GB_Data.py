...
class YoutubeCrawler():
    first_url = 'https://www.googleapis.com/youtube/v3/videos?part=snippet,statistics&regionCode=GB&chart=mostPopular&key=AIzaSyCBJKDBn1bjnfdtQQip5SMK3j5uKeHK7mc&maxResults=50{}'
...
if __name__ == '__main__':  #主函数
    ...
    #写入文件
    with open('GBvideos_New.json','w',encoding='utf-8') as f :
